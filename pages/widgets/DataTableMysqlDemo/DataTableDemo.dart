...
import 'package:forum_republique/pages/widgets/DataTableMysqlDemo/services.dart';
import 'dart:async';

import 'adhérents.dart';

class DataTableDemoo extends StatefulWidget {
  //
  DataTableDemoo() : super();
...
class Debouncer {
  ...
  Debouncer({required this.milliseconds,required this.timer,required this.action});
...
class DataTableDemoState extends State<DataTableDemoo> {
  ...
  // battery life...
  final _debouncer = Debouncer(milliseconds: 2000, timer: Timer.periodic(Duration(seconds: 1), (timer) { }) , action: () {  });
