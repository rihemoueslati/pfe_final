...
import 'package:forum_republique/models/Profilemodel.dart';
...
class ProfilePage extends StatefulWidget{
 ...
 class _ProfilePageState extends State<ProfilePage>{
  ...
  // //  setState(() {
  // //    profileModel = ProfilModel.fromJson(response);
  // //    circular = false ;
  // //  });
  //
  // // }
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 20,),
                  Text(profileModel.firstname, style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),),
                  SizedBox(height: 20,),
